...
const EmailNode = ({ data, onChange }) => {
  ...
  const handleChange = (e) => {
    ...
    setEmail(value);
    if (onChange) onChange({ ...data, email: value });
  };
  ...
  return (
    <div className="bg-[#1e1e1e] p-6 rounded-md w-56 text-white font-sans shadow-lg relative">
      {/* Cross (delete) button */}
      <button
      ...
      <input
        ...
        required
      />
      <small className="text-gray-400 mt-3 text-center block">
